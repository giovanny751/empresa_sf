...
<div class='well'>
    <form action="<?php echo base_url('index.php/')."/Ciudad/save_ciudad"; ?>" method="post" onsubmit="return campos()"  enctype="multipart/form-data">
        <div class="row">
                    ...
                    <div class="col-md-3">
                        <label for="pai_id">
                            <i class="fa fa-question-circle" aria-hidden="true" title="Nombre del país de residencia."></i>*                             Pais                        </label>
                    </div>
                    <div class="col-md-3">
                    ...
                    <div class="col-md-3">
                        <label for="ciu_nombre">
                            <i class="fa fa-question-circle" aria-hidden="true" title="Nombre de la ciudad de residencia."></i>*                             Nombre ciudad                        </label>
                    </div>
                    <div class="col-md-3">
