...
<div class='well'>
    <form action="<?php echo base_url('index.php/')."/Validez_oferta/save_validez_oferta"; ?>" method="post" onsubmit="return campos()"  enctype="multipart/form-data">
        <div class="row">
        ...
        <div class="row">
            <span id="boton_guardar">
                ...
                <a href="<?php echo base_url('index.php')."/Validez_oferta/consult_validez_oferta" ?>" class="btn btn-dcs">Listado </a>
            </span>
