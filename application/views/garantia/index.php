...
<div class='well'>
    <form action="<?php echo base_url('index.php/') . "/Garantia/save_garantia"; ?>" method="post" onsubmit="return campos()"  enctype="multipart/form-data">
        ...
        *                             Nombre                        </label>
            ...
            <div class="col-md-3">
                <input type="text" value="<?php echo (isset($datos[0]->nombre) ? $datos[0]->nombre : '' ) ?>" class=" form-control obligatorio  " id="nombre" name="nombre" title="Ingresar tiempo de garantía de los productos.">
